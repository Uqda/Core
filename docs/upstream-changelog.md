# Upstream Yggdrasil release history

These entries are inherited from the upstream source. They describe upstream
releases, not Uqda releases. Original product names and dates are preserved.
