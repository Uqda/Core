...
**شبكة Uqda** (من العربية **عُقدة** بمعنى "عقدة") هي بروتوكول توجيه لامركزي لبناء شبكات mesh متعددة القفزات مرنة وذاتية التنظيم مع تشفير من طرف إلى طرف.
...
شبكة Uqda مبنية على مشروع [Yggdrasil Network](https://yggdrasil-network.github.io/).
