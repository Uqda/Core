...
تبقى العقد الجديدة متوافقة مع عقد البروتوكول `0.5`. وعندما يدعم الطرفان المصافحة المحسّنة فإنهما يفعّلانها تلقائيًا. ولإلزام رابط مُدار باستعمال المصافحة المحسّنة ورفض العقد القديمة، أضف `?secure=required` إلى رابط النظير ورابط الاستماع على الطرفين.
