...
func (s *wsServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// Wire protocol identifier — kept as "ygg-ws" for compatibility
	// with existing Yggdrasil/Uqda network peers.
	// Change only when deploying a standalone Uqda-only network.
	...
	// Same negotiated subprotocol as in AcceptOptions above.
