...
// Address represents an IPv6 address in the network address range.
type Address [16]byte

// Subnet represents an IPv6 /64 subnet in the network subnet range.
type Subnet [8]byte

// GetPrefix returns the address prefix used by the network.
