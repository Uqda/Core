...
func (tun *TunAdapter) setupAddress(addr string) error {
	...
	//
	// WARNING: FreeBSD TUN support is incomplete.
	// This implementation may not function correctly on FreeBSD.
	// Contributions and testing are welcome. Track issue:
	// https://github.com/Uqda/Core/issues
	// Do not advertise FreeBSD TUN support as production-ready
	// until this FIXME is resolved.
	//
	// FIXME: I don't work!
