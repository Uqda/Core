...
// Uqda.Adapter type. In order to use the TUN adapter with Uqda, you
// should pass this object to the Uqda.SetRouterAdapter() function before
// calling Uqda.Start().
...
// the Uqda core before this point and it must not be in use elsewhere.
